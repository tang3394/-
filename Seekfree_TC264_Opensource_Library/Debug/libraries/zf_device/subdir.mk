...
"libraries/zf_device/zf_device_mt9v03x.o":"libraries/zf_device/zf_device_mt9v03x.src" "libraries/zf_device/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
"libraries/zf_device/zf_device_mt9v03x2.src":"../libraries/zf_device/zf_device_mt9v03x2.c" "libraries/zf_device/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2004 -D__CPU__=tc26xb "-fD:/car/Seekfree_TC264_Opensource_Library/Debug/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -Y0 -N0 -Z0 -o "$@" "$<"
"libraries/zf_device/zf_device_mt9v03x2.o":"libraries/zf_device/zf_device_mt9v03x2.src" "libraries/zf_device/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
